...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_split_3x5_3(
    QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      RM_TOGG,  RM_HUED, RM_HUEU, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      RM_NEXT,  RM_SATD, RM_SATU, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      RM_PREV, RM_VALD, RM_VALU, XXXXXXX, XXXXXXX,
