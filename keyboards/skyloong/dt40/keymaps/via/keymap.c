...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
         RM_TOGG,  RGB_M_P,  RGB_M_R,  RGB_M_B, RGB_M_SW, _______, _______, _______,   KC_EQL, KC_MINS,  _______,
         _______,  _______,  _______,  _______,  _______, _______, _______, _______,  KC_RBRC, KC_BSLS,  _______,
         _______,  _______,  _______,  _______,  _______, _______, _______, _______,  _______, RM_VALU,  _______,
         _______,  _______,  _______,  _______,  _______, KC_LBRC, _______, _______, RM_PREV, RM_VALD,  RM_NEXT
    ),
