...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT( /* FN */
        ...
        _______, GU_TOGG, _______,                   EE_CLR,                             _______, _______, _______,          RM_HUED,  RM_VALD, RM_HUED),
    ...
    [MAC_FN] = LAYOUT( /* FN */
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,  RM_VALU,
        _______, _______, _______,                   EE_CLR,                             _______, _______, _______,          RM_HUED,  RM_VALD, RM_HUED)
};
